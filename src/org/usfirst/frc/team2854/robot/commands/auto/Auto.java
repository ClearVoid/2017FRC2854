...
public class Auto extends Command{
	...
	private final String ip = "10.28.54.214";
...
//		double distance = (visualData[0].getDistance() + visualData[1].getDistance())/2.0;
//		double angle = (visualData[0].getAngle() + visualData[1].getAngle())/2.0;
